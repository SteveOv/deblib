...
"""
    ...
    #
    # Tests execute_task(in_file, out_file, raise_warnings, stdout_to) -> void:
    #
    def test_execute_task_valid(self):
        ...
        jktebop.execute_task(in_file, out_file, True, stdout_to)

        # Assert processing
        self.assertTrue(out_file.exists())
        model = np.loadtxt(out_file, comments="#", dtype=np.double, unpack=True)
    ...
    def test_execute_task_missing_in_file(self):
        ...
        with self.assertRaises(FileNotFoundError):
            jktebop.execute_task(in_file, out_file, None)


    #
    # Tests execute_task_async(in_file) -> Popen[str]:
    #
