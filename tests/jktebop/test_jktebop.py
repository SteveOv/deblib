...
"""
    ...
    def test_execute_task_valid(self):
        ...
        in_file, out_file = self._test_specific_in_and_out_filenames()
        ...
        out_lines = [*jktebop.execute_task(in_file, out_file, cleanup_pattern, True, stdout_to)]
    ...
    # Helper functions
    def _test_specific_in_and_out_filenames(self):
